...
# from 1 to X are covered by leaves). You may assume that the speed of the current in the
# river is negligibly small, i.e. the leaves do not change their positions once they fall
# in the river.
#
